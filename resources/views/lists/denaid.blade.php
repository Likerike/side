...
<section class="u-align-center u-clearfix u-section-7" id="carousel_7f4a">
  <div class="u-clearfix u-sheet u-sheet-1">
    <h1 class="u-custom-font u-font-oswald u-text u-text-default u-text-1">История отказов</h1>
    <div class="u-expanded-width u-table u-table-responsive u-table-1">
      <table class="u-table-entity u-table-entity-1">
        ...
        <tbody class="u-align-center u-table-body">
          @foreach($repairdenaid as $key => $ord)
          <tr style="height: 75px;">
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $key }}</td>
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $ord->name }} {{ $ord->surname }}</td>
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $ord->created_at }}</td>
            <td class="u-border-1 u-border-grey-30 u-table-cell">Ремонт</td>
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $ord->problem }}</td>
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $ord->status }}</td>
          </tr>
          @endforeach

          @foreach($assemblydenaid as $key => $oa)
          <tr style="height: 75px;">
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $key }}</td>
          ...
          @foreach($settingdenaid as $key => $os)
          <tr style="height: 75px;">
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $key }}</td>
          ...
          @foreach($scooldenaid as $key => $osc)
          <tr style="height: 75px;">
            <td class="u-border-1 u-border-grey-30 u-table-cell">{{ $key }}</td>
    ...
    <a href="{{ route('history') }}" class="u-btn u-button-style u-custom-font u-font-oswald u-btn-1">Назад</a>
  </div>
</section>
